...
const ContentAnalyzer = () => {
    ...
    // Studio action cards
    const studioActions = [
        { icon: <FiMic />, label: 'Audio Overview', iconClass: 'audio', action: () => toast('Coming soon!') },
        ...
        { icon: <FiBarChart />, label: 'Reports', iconClass: 'reports', action: () => toast('Coming soon!') },
        {
            ...
            action: () => selectedContent ? navigate(`/flashcards?contentId=${selectedContent._id}`) : toast.error('Select a document first')
        },
        {
            icon: <FiHelpCircle />,
            label: 'Quiz',
            iconClass: 'quiz',
            action: () => selectedContent ? navigate(`/quiz?contentId=${selectedContent._id}`) : toast.error('Select a document first')
        },
        ...
        <div className="notebook-container">
            ...
            <main className="chat-panel">
                <div className="chat-header">
                    <span style={{ color: '#707070', fontSize: '14px' }}>Chat</span>
                </div>
                            ...
                            {selectedContent.summary?.detailedAnalysis ? (
                                <>
                                    <div className="doc-summary">
                                        {formatText(selectedContent.summary.detailedAnalysis)
                                            .split('\n')
                                            .map((line, idx) => (
                                                <p key={idx}>{line || '\u00A0'}</p>
                                            ))
                                    ...
                                    <div className="summary-actions">
                                        ...
                                        <button className="action-btn-icon"><FiCopy /></button>
